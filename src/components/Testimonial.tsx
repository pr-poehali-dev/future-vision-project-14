...
export function Testimonial() {
  ...
  return (
    <section ref={sectionRef} className="py-16 lg:py-20 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Через Сарафан нашла своего мастера по маникюру — подруга порекомендовала, получила приятный бонус. Теперь и я сама советую его всем знакомым и тоже зарабатываю. Это работает как настоящее сарафанное радио.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Клиент и посредник</p>
        </div>
      </div>
    </section>
  )
