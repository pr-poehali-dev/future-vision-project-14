...
export function Hero() {
  ...
  return (
    <section className="relative flex items-center justify-center px-6 lg:px-12 pt-8 pb-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Платформа доверенных рекомендаций
        </p>
        ...
        >
          Найди своего
          <span className="block text-sage">специалиста</span>
        </h1>
        ...
        >
          Мой Сарафан объединяет специалистов, клиентов и тех, кто умеет советовать. Найдите проверенного мастера — или зарабатывайте, рекомендуя его другим.
        </p>
