...
const steps = [
  {
    ...
    title: "Регистрация",
    description:
      "Создайте аккаунт и выберите, кем хотите быть: специалистом, клиентом или посредником. Или сразу всеми тремя — без ограничений.",
  },
  {
    number: "02",
    title: "Профиль",
    description:
      "Специалисты описывают свои услуги и устанавливают размер вознаграждения за рекомендацию. Клиенты заполняют, что ищут.",
  },
  {
    number: "03",
    title: "Рекомендации",
    description:
      "Посредники делятся своей персональной ссылкой на специалиста. Когда по ней приходит клиент — посредник получает вознаграждение.",
  },
  {
    number: "04",
    title: "Сделка",
    description:
      "Клиент находит нужного специалиста, договаривается напрямую и оставляет отзыв. Сарафан работает как умный проводник между людьми.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> доверия</span>
              </h2>
              <p
              ...
              >
                Сарафан — это не доска объявлений. Это экосистема доверия, где каждая рекомендация стоит за собой живым опытом человека.
              </p>
            </div>
          </div>
