...
export function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="py-16 lg:py-20 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Оставьте заявку — и мы свяжемся с вами, чтобы помочь начать работу на платформе в нужной роли.
            </p>
            ...
            >
              <div>
                ...
                <a href="mailto:infomysarafan@mail.ru" className="text-foreground hover:text-sage transition-colors">
                  infomysarafan@mail.ru
                </a>
              </div>
              <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="В какой роли хотите начать? Что ищете?"
                  required
                />
              </div>
              <button
